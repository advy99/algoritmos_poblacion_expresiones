...
OBJETOS_PG_ALGS = $(OBJ)/Nodo.o $(OBJ)/Expresion.o $(OBJ)/AlgoritmoPG.o $(OBJ)/Expresion_GAP.o $(OBJ)/AlgoritmoGA_P.o $(OBJ)/Random.o $(OBJ)/aux_pg_algs.o
...
$(OBJ)/AlgoritmoPG.o: $(SRC)/AlgoritmoPG.cpp $(INC)/AlgoritmoPG.hpp $(INC)/Expresion.hpp $(INC)/Nodo.hpp $(PG_ALGS_INC_COMUNES)
	$(call compilar_objeto,$<,$@)
